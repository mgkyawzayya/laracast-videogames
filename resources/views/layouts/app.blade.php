            ...
            <div class="flex items-center">
                ...
                <ul class="flex ml-16 space-x-8">
                    <li>
                        ...
                        <a href="/comming-soon" class="hover:text-gray-400">Coming Soon</a>
                    </li>
                </ul>
            </div>
            <div class="flex items-center">
                <div class="relative">
                    <input type="text" class="bg-gray-800 text-sm rounded-full focus:outline-none focus:shadow-outlline w-64 px-3 py-1" placeholder="Search ...">
                </div>
                <div class="ml-6">
